...
/**
 * force logback for test
 * somehow log4j slf4j bindidng is in classbath for eclipse although export in core is disabled and its only a testcompile dependency
 * 
 * 
 * 
 * 
