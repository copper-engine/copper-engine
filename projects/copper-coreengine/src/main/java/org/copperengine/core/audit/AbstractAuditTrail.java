 ...
 * @author austermann
 */
public abstract class AbstractAuditTrail implements AuditTrail, AuditTrailMXBean {

    private static final Logger logger = LoggerFactory.getLogger(AbstractAuditTrail.class);
    ...
    public static List<Property2ColumnMapping> createDefaultMapping() {
        List<Property2ColumnMapping> mapping = new ArrayList<AbstractAuditTrail.Property2ColumnMapping>();
    ...
    public void setAdditionalMapping(List<Property2ColumnMapping> mapping) {
        ArrayList<Property2ColumnMapping> newMapping = new ArrayList<AbstractAuditTrail.Property2ColumnMapping>();
