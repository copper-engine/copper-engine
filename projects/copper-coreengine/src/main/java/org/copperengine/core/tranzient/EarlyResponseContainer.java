...
/**
 * A transient container for early response. In the context of COPPER, a reponse is called early, if an asynchronous
 * response
 ...
 * response in this container. Later on, the engine will ask the container for every <code>wait</code> if a response for
 * this
