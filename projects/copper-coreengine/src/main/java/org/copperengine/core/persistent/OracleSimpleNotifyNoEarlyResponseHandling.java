...
class OracleSimpleNotifyNoEarlyResponseHandling {
    ...
    private static final String SQL =
            "INSERT INTO COP_RESPONSE (CORRELATION_ID,RESPONSE_TS,RESPONSE,RESPONSE_TIMEOUT,RESPONSE_META_DATA) " +
                    ...
                    "(select ? as correlation_id, ? as response_ts, ? as response, ? as response_timeout, ? as response_meta_data from dual) D " +
