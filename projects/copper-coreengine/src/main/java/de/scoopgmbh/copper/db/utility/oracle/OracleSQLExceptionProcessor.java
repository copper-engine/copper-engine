 ...
 */
package de.scoopgmbh.copper.db.utility.oracle;

import java.sql.SQLException;
import java.util.Collections;
import java.util.List;

import de.scoopgmbh.copper.db.utility.SQLExceptionProcessor;
...
public class OracleSQLExceptionProcessor implements SQLExceptionProcessor {
    ...
    public boolean retryPossible(SQLException e) {
        return !noRetryErrorCodes.contains(e.getErrorCode());
    }
