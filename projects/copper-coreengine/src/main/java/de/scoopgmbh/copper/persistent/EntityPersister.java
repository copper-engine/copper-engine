...
public interface EntityPersister<E> {
	...
	/**
	 * Issues a select for the entity that will be executed later. The entity has to contain the identifying data used to select it. Later on, the callback is called either via {@link #entitySelected(E) entitySelected} or {@link #entityNotFound(E) entityNotFound} 
