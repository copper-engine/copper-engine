...
public class VersioningTest {
    ...
    public void testLatest() throws Exception {
        try (TransientEngineTestContext ctx = new TransientEngineTestContext()) {
            ...
            assertEquals("org.copperengine.regtest.test.versioning.VersionTestWorkflow_14_5_67", workflowClassname);
        }
    }
    ...
    public void testVersion() throws Exception {
        try (TransientEngineTestContext ctx = new TransientEngineTestContext()) {
            ...
            assertEquals("org.copperengine.regtest.test.versioning.VersionTestWorkflow_1_0_1", workflowClassname);
        }
