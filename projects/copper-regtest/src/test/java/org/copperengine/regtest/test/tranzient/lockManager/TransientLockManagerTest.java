    ...
    public void testWorkflow() throws Exception {
        try (TransientEngineTestContext ctx = new TransientEngineTestContext()) {
            ...
            for(int i=0; i<NUM_WORKFLOWS_TO_LAUNCH; i++) {
                ...
                wfsToBeLaunched.add(
                        new WorkflowInstanceDescr<Integer>("org.copperengine.regtest.test.tranzient.TransientLockManagerTestWorkflow",
                                data,
                                "Workflow-"+i,
                                5,
                                null));
            ...
            for (int i=0; i<2; i++) {
                try {
                    ctx.getEngine().run(new WorkflowInstanceDescr<Integer>("org.copperengine.regtest.test.tranzient.TransientLockManagerTestWorkflow",
                            0,
                            "WorkflowRunTwo-" + i,
                            5,
                            null));
