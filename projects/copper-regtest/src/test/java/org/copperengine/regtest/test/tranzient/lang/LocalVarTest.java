...
public class LocalVarTest {
    ...
    public void testWorkflow() throws Exception {
        doTest("org.copperengine.regtest.test.tranzient.lang.LocalVarTransientWorkflow1", 15);
    }

    @Test
    public void testWorkflow2() throws Exception {
        doTest("org.copperengine.regtest.test.tranzient.lang.LocalVarTransientWorkflow2", 5);
