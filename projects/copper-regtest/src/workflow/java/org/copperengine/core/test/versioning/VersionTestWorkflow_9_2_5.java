...
@WorkflowDescription(alias=VersionTestWorkflowDef.NAME,majorVersion=9,minorVersion=2,patchLevelVersion=5)
public class VersionTestWorkflow_9_2_5 extends Workflow<BlockingResponseReceiver<String>> {
